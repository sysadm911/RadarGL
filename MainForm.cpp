...
void __fastcall TForm1::BtnDebugClick(TObject *Sender) {
	...
	if (edt_beta3->Text != "" && edt_beta0->Text != "") {
		...
		Memo1->Lines->Add("Кол-во излученных пакетов за время наблюдения цели = " +
		...
		Memo1->Lines->Add("Кол-во излученных парциальных запусков (дискретов дальности) за время наблюдения цели = " +
		...
		Memo1->Lines->Add("Кол-во мегабайт для хранения массива = " + FloatToStr(4*ugol / 2.0713 * GetCountPulsesOfPacket()) /
			(1024. *1024.));
		Memo1->Lines->Add("");
