...
// ID- объектов для быстрого вывода glCallList(ID)
...
int dalnost = 450000; // ДАЛЬНОСТЬ 400 км
// для сплайна-сетки
...
int gl_cntrot = 0; // глобальный номер оборота
long double gl = 0.9; // проекция-
long double gl_inc = 0.03; // шаг изменения проекции
long double km = 1.0; // масштаб
GLfloat glx = 0; // смещение проекции по X
GLfloat gly = 0; // смещение проекции по Y
GLfloat ry, tx, ty, rz, ang; // поворот- XYZA
